...
const HeroCards = ({ name, image, duration, year, genre, link }) => {
  return (
    <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 p-5 md:p-8 lg:p-10">
      ...
      >
        <div className="flex justify-center lg:justify-between  min-w-full drop-shadow-2xl bg-opacity-5 bg-blend-saturation shadow-black tracking-wide bg-black/50 lg:bg-transparent py-5">
          ...
          <div className="pr-20 py-10 hidden lg:flex gap-3 justify-end tracking-wide">
